            ...
            <form role="form" method="post" action="<?=base_url();?>course_feedback/insertFeedback">
                <div class="form-inline">
                    ...
                    <div class="form-group">
                        ...
                        echo form_dropdown('instructor', $options, '', 'class="form-control custom-text"');
                        ?>
                    </div>
                    <div class="form-group">
                        <label for="w_spent_time_hour">Weekly Spent Hour:</label>
                        <input type="text" class="form-control wid30" name="w_spent_time_hour" maxlength="2" pattern="^[0-9]+\d?" placeholder="in hour" required>
                    </div>
                    <br>
                    <br>
                    <div class="form-group">
                ...
                <table class="table feedback-table">
                    ...
                    <tbody>
                        <tr>
                            <td rowspan="3"><p class="deg90">The Course Contents <br> and Organization</p></td>
                            <td>1</td>
                        ...
                        <tr>
                            <td>3</td>
                            <td>The course contents are well-organized; the contents encouraged me to participate</td>
                        ...
                        <tr>
                            <td rowspan="3"><p class="deg90">Learning Resources</p></td>
                            <td>4</td>
                        ...
                        <tr>
                            <td rowspan="3"><p class="deg90">Additional Questions</p></td>
                            <td>7</td>
