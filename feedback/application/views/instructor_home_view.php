    ...
    <div class="row">
        <div class="col-md-12 col-ms-12 col-xs-12">
            ...
            <?php $k=1; for ($i = 0; $i < count($my_courses); ++$i) {?>
                ...
                <p><?php echo $k.'. ('.$my_courses[$i]->semester_id.') <a href="'.base_url().'instructor_home/feedback_summery_course_wise/'.$username.'/'.$my_courses[$i]->course_id.'/'.$my_courses[$i]->semester_id.'">'.$my_courses[$i]->course_id.'</a> &raquo;'.' <a href="'.base_url().'instructor_home/feedback_summery_teacher_wise/'.$username.'/'.$my_courses[$i]->course_id.'/'.$my_courses[$i]->semester_id.'"> Me'.'</a>' ?> </p>
                <?php $k++;} ?>
        </div>
