        ...
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            ...
            <div class="account-wall">
                ...
                <form method="post" action="<?=base_url();?>login">
                    ...
                    <center><a href="<?=base_url();?>forgot" class="need-help">Forgot password ?</a> &nbsp; or &nbsp; <a href="<?=base_url();?>request" class="need-help">Request for password ?</a><span class="clearfix"></span></center>
                </form>
            </div>
